                ...
                <div className="bg-white rounded-4 p-2 flex-fill">
                  <div className="row">
                    <div className="col-sm ratio ratio-1x1">
                      <img src="" width="5" height="5" class="rounded float-center" alt="" />
                    </div>

                    <div className="col-sm">
                      <div className="mb-3">
                        <label for="admreffloatingInput" className="text-muted">
                          Employee ID:
                        </label>
                      ...
                      <a
                          ...
                          >
                            <svg className="bi" width="36" height="36">
